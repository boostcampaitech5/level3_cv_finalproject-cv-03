...
nohup_run_dreambooth_worker:
	nohup celery -A src.scratch.worker_dreambooth.celery_app worker -l info -E -Q dreambooth > ./celery_worker_dreambooth.log 2>&1 &

nohup_run_sdxl_worker:
	nohup celery -A src.scratch.worker_sdxl.celery_app worker -l info -E -Q sdxl > ./celery_worker_sdxl.log 2>&1 &
