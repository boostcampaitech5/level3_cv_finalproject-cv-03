...
if __name__ == "__main__":
    ...
    trained_model = str(os.path.join("/opt/ml/level3_cv_finalproject-cv-03/dreambooth/weights", token, "pytorch_lora_weights.bin"))

    save_dir = f"/opt/ml/level3_cv_finalproject-cv-03/dreambooth/data/results/{token}"
    ...
    latent_image = pipe(prompt=prompt, num_inference_steps=n_steps, num_images_per_prompt=4).images
