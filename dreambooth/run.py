...
if __name__ == "__main__":
    ...
    command += f" --instance_data_dir=/opt/ml/level3_cv_finalproject-cv-03/dreambooth/data/users/{token}"
    command += f" --output_dir=/opt/ml/level3_cv_finalproject-cv-03/dreambooth/weights/{token}"
    ...
    if config["WITH_PRIOR_PRESERVATION"]:
        ...
        command += f" --class_data_dir=/opt/ml/level3_cv_finalproject-cv-03/dreambooth/data/generated/{class_name}"
